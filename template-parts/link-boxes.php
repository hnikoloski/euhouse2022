<div id="link-boxes">
    <div class="single-box" style="background: url('<?= the_field('events_background'); ?>');">
        <div class="content">
            ...
            <a href="/events" class="btn btn-white mx-auto yellow-deco"><?= __('View More', 'starter'); ?> <i class="fal fa-long-arrow-right"></i></a>
        </div>
    </div>
    <div class="single-box" style="background: url('<?= the_field('news_background'); ?>');">
        <div class="content">
            ...
            <a href="/blog" class="btn btn-white mx-auto yellow-deco"><?= __('View More', 'starter'); ?> <i class="fal fa-long-arrow-right"></i></a>
        </div>
    </div>
    ...
    <div class="single-box fancy blue" style="background: url('<?= the_field('culture_background'); ?>');">
        <div class="content">
            ...
            <a href="/events" class="btn btn-blank mx-auto"><?= __('View More', 'starter'); ?> <i class="fal fa-long-arrow-right"></i></a>
        </div>
    </div>
