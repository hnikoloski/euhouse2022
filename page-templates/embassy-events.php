...
/*Template Name: Embasy Events */

get_header(); ?>

<header class="single-page-header page-padding-x d-flex flex-wrap">
    <h2 class="heading blue-bg w-fit-content"><?php _e('EU Embassy Events', 'starter'); ?></h2>
</header>
        ...
        ?>
            ...
            <div class="row">
                <div class="col col-full">
                    <h4><?php _e('No upcoming Embasy events', 'starter'); ?></h4>
                </div>
            <?php
        }
